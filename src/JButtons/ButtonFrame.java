...
public class ButtonFrame extends JFrame {
    ...
    public ButtonFrame() {
        ...
        Icon bug1 = new ImageIcon(getClass().getResource("../imgs/bug1.gif"));
        Icon bug2 = new ImageIcon(getClass().getResource("../imgs/bug2.gif"));
